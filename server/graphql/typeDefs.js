...
module.exports=gql` 
    #Schemata für die Digimon -> name, img & level kommen aus der DigimonAPI, cards aus der CardsAPI
    type Digimon {
        name: String!
        img: String!
        level: String!
    ...
    #Schemata für die favorisierten Digimon aus der DB
    type Favorite {
        username: String!,
        cardname: String!,
    }
    ...
    type Query {
        #return name, img & level aller Digimon der Serie -> Datenabfrage der DigimonAPI
        allDigimon: [Digimon] 

        #return ein Digimon gesucht nach Namen -> Datenabfrage der DigimonAPI
        digimonByName(name: String): [Digimon]
        
        #return Digimon eines bestimmten levels -> Datenabfrage der DigimonAPI
        digimonByLevel(level: String): [Digimon]
        
        #return cardnumber & name aller Cards -> Datenabfrage der CardsAPI
        allCards: [Cards!]  
        
        #return alle type Cards Attribute eines spezifischen Digimons (Abfrage mit name) -> Datenabfrage der CardsAPI 
        cardsByName(name: String): [Cards!] 
        
        #return alle Digimon (incl cards) Attribut für ein spezifisches Digimon -> Vereinigung beider REST API Rückgaben
        ...
        #return ein Favorite von dem eingegebenen Username aus der DB
